...
function SomethingSpecialEffect({
  className,
  speed = 1,
  onAnimationComplete,
  ...props
  ...
  return (
    <motion.svg
      ...
      {...props}
    >
      <title>Something special awaits you</title>

      {/* "Something special" — line 1 */}
      <motion.text
        x="260"
        y="72"
        textAnchor="middle"
        ...
        fontSize="54"
        style={{ strokeDasharray: 5000 }}
        initial={{ strokeDashoffset: 5000, opacity: 0 }}
        animate={{ strokeDashoffset: 0, opacity: 1 }}
        transition={{
          strokeDashoffset: { duration: calc(2.8), ease: "easeInOut" },
      ...
      <motion.text
        ...
        fontFamily="'Dancing Script', cursive"
        fontSize="54"
        style={{ strokeDasharray: 3500 }}
        initial={{ strokeDashoffset: 3500, opacity: 0 }}
        animate={{ strokeDashoffset: 0, opacity: 1 }}
        transition={{
          strokeDashoffset: { duration: calc(2.2), ease: "easeInOut", delay: calc(2.6) },
          opacity: { duration: 0.01, delay: calc(2.6) },
        }}
        onAnimationComplete={onAnimationComplete}
      >
        awaits you
...
export { AppleHelloEnglishEffect, AppleHelloVietnameseEffect, SomethingSpecialEffect };
